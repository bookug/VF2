...
do
 ...
 ./vf2.exe /home/data/DATASET/delaunay_n13.g ${query} ${result1}${file%.*}.txt >& ${result1}${file%.*}.log
 #./GSI.exe /home/data/DATASET/delaunay_n13.g ${query} ${result1}${file%.*}.txt>& ${result1}${file%.*}.log
 #./GSI.exe /home/data/DATASET/delaunay_n13.g ${query} ${result1}${file%.*}.txt>& ${result1}${file%.*}.log
...
do
    file=${query##*/}
    ./vf2.exe /home/data/DATASET/enron.g ${query} ${result2}${file%.*}.txt>& ${result2}${file%.*}.log
...
#do
 #file=${query##*/}
 #./GSI.exe /home/data/DATASET/gowalla.g ${query} ${result3}${file%.*}.txt>& ${result3}${file%.*}.log
...
#do
 #file=${query##*/}
 #./vf2.exe /home/data/DATASET/road_central.g ${query} ${result4}${file%.*}.txt >& ${result4}${file%.*}.log
...
##do
 ##file=${query##*/}
 ##./GSI.exe /home/data/DATASET/watdiv100M.g ${query} ${result5}${file%.*}.txt>& ${result5}${file%.*}.log
...
##do
 ##file=${query##*/}
 ##./GSI.exe /home/data/DATASET/dbpedia170M.g ${query} ${result6}${file%.*}.txt>& ${result6}${file%.*}.log
