...
# nvprof -m gld_transactions -m gst_transactions ./vf2.exe /home/data/DATASET/gowalla/loc-gowalla_edges.g /home/data/DATASET/gowalla/query/q0.g >& gowalla.prof
...
do
 qq=${query##*/}
 ./vf2.exe /home/data/DATASET/watdiv10M.g ${query} ${result}${qq%.*}.txt >& ${result}${qq%.*}.log
...
do
 qq=${query##*/}
 ./vf2.exe /home/data/DATASET/watdiv20M.g ${query} ${result}${qq%.*}.txt >& ${result}${qq%.*}.log
 grep "match used" ${result}${qq%.*}.log >> ${file}
done
...
do
 qq=${query##*/}
 ./vf2.exe /home/data/DATASET/watdiv30M.g ${query} ${result}${qq%.*}.txt >& ${result}${qq%.*}.log
 grep "match used" ${result}${qq%.*}.log >> ${file}
done
...
do
 qq=${query##*/}
 ./vf2.exe /home/data/DATASET/watdiv40M.g ${query} ${result}${qq%.*}.txt >& ${result}${qq%.*}.log
 grep "match used" ${result}${qq%.*}.log >> ${file}
done
...
do
 qq=${query##*/}
 ./vf2.exe /home/data/DATASET/watdiv50M.g ${query} ${result}${qq%.*}.txt >& ${result}${qq%.*}.log
 grep "match used" ${result}${qq%.*}.log >> ${file}
done
...
do
 qq=${query##*/}
 ./vf2.exe /home/data/DATASET/watdiv60M.g ${query} ${result}${qq%.*}.txt >& ${result}${qq%.*}.log
 grep "match used" ${result}${qq%.*}.log >> ${file}
done
...
do
 qq=${query##*/}
 ./vf2.exe /home/data/DATASET/watdiv70M.g ${query} ${result}${qq%.*}.txt >& ${result}${qq%.*}.log
 grep "match used" ${result}${qq%.*}.log >> ${file}
done
...
do
 qq=${query##*/}
 ./vf2.exe /home/data/DATASET/watdiv80M.g ${query} ${result}${qq%.*}.txt >& ${result}${qq%.*}.log
 grep "match used" ${result}${qq%.*}.log >> ${file}
done
...
do
 qq=${query##*/}
 ./vf2.exe /home/data/DATASET/watdiv90M.g ${query} ${result}${qq%.*}.txt >& ${result}${qq%.*}.log
 grep "match used" ${result}${qq%.*}.log >> ${file}
done
...
do
 qq=${query##*/}
 ./vf2.exe /home/data/DATASET/watdiv100M.g ${query} ${result}${qq%.*}.txt >& ${result}${qq%.*}.log
 grep "match used" ${result}${qq%.*}.log >> ${file}
done
